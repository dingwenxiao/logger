 ...
 */
public class GbLoggerFactory extends AbstractLoggerAdapter<Logger> implements ILoggerFactory {

  private static final String FQCN = GbLoggerFactory.class.getName();
  ...
  protected Logger newLogger(final String name, final LoggerContext context) {
    ...
    return new GbLoggerAdapter(context.getLogger(key), name);
  }
  ...
  protected LoggerContext getContext() {
    ...
    return anchor == null ? LogManager.getContext()
        : getContext(ReflectionUtil.getCallerClass(anchor));
  }
